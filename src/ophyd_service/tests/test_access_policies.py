...
from ophyd_service.authorization import (
...
from ophyd_service.config_schemas.loading import ConfigError
...
def access_api_server(xprocess):
    server_module = "ophyd_service.tests.access_api_server.api_server"
        ...
        - provider: toy
          ...
          args:
              users_to_passwords:
                  ...
                  tom: tom_password
api_access:
    policy: ophyd_service.authorization:ServerBasedAPIAccessControl
    args:
        instrument: tst
        server: localhost
        port: 60001
